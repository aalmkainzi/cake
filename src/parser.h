...
struct enumerator* _Opt find_enumerator(const struct parser_ctx* ctx, const char* name, struct scope** _Opt ppscope_opt);
struct map_entry* _Opt find_variables(const struct parser_ctx* ctx, const char* name, struct scope* _Opt* _Opt ppscope_opt);
